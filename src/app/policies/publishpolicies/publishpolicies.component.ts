...
@Component({
  selector: 'app-publishpolicies',
  templateUrl: './publishpolicies.component.html',
  styleUrls: ['./publishpolicies.component.css']
})
export class PublishpoliciesComponent implements AfterViewInit {
