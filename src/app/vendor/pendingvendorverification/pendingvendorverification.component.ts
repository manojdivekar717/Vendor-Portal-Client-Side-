...
@Component({
  selector: 'app-pendingvendorverification',
  templateUrl: './pendingvendorverification.component.html',
  styleUrls: ['./pendingvendorverification.component.css']
})
export class PendingvendorverificationComponent implements AfterViewInit {
